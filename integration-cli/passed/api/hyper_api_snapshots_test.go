...
func (s *DockerSuite) TestSnapshotsApiCreate(c *check.C) {
...
func (s *DockerSuite) TestSnapshotsApiList(c *check.C) {
	dockerCmd(c, "volume", "create", "--name", "test")
...
func (s *DockerSuite) TestSnapshotsApiRemove(c *check.C) {
	dockerCmd(c, "volume", "create", "--name", "test")
...
func (s *DockerSuite) TestSnapshotsApiInspect(c *check.C) {
	dockerCmd(c, "volume", "create", "--name", "test")
